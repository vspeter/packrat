# -*- coding: utf-8 -*-
# Generated by Django 1.11.11 on 2019-01-07 16:19
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tag', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='+', to='Attrib.Tag')),
            ],
            options={
                'default_permissions': (),
            },
        ...
        migrations.AddField(
            ...
            name='tag_list',
            field=models.ManyToManyField(related_name='_packagefile_tag_list_+', through='Package.PackageFileTag', to='Attrib.Tag'),
        ),
